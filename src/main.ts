...
if (process.env.JT_SKIP_DEFAULT_DOTENV !== '1') {
  loadEnv({ path: process.env.JT_ENV_FILE || '.env' });
}
...
async function bootstrap() {
  ...
  // Cloud Run entrega la IP pública en X-Forwarded-For; necesaria para rate limit por visitante.
